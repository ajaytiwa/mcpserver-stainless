...
from ._exceptions import APIStatusError, PetstoreramlError
...
class Petstoreraml(SyncAPIClient):
    pets: pets.PetsResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: PetstoreramlWithRawResponse
    with_streaming_response: PetstoreramlWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Petstoreraml client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("PETSTORERAML_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = PetstoreramlWithRawResponse(self)
        self.with_streaming_response = PetstoreramlWithStreamedResponse(self)
...
class AsyncPetstoreraml(AsyncAPIClient):
    pets: pets.AsyncPetsResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncPetstoreramlWithRawResponse
    with_streaming_response: AsyncPetstoreramlWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncPetstoreraml client instance.
        ...
        self.with_raw_response = AsyncPetstoreramlWithRawResponse(self)
        self.with_streaming_response = AsyncPetstoreramlWithStreamedResponse(self)
...
class PetstoreramlWithRawResponse:
...
class AsyncPetstoreramlWithRawResponse:
...
class PetstoreramlWithStreamedResponse:
    def __init__(self, client: Petstoreraml) -> None:
...
class AsyncPetstoreramlWithStreamedResponse:
    def __init__(self, client: AsyncPetstoreraml) -> None:
