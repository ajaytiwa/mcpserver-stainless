...
from petstoreraml import Petstoreraml, AsyncPetstoreraml, APIResponseValidationError
from petstoreraml._types import Omit
from petstoreraml._models import BaseModel, FinalRequestOptions
from petstoreraml._constants import RAW_RESPONSE_HEADER
from petstoreraml._exceptions import APIStatusError, APITimeoutError, PetstoreramlError, APIResponseValidationError
from petstoreraml._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Petstoreraml | AsyncPetstoreraml) -> int:
...
class TestPetstoreraml:
    client = Petstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "petstoreraml/_legacy_response.py",
                        "petstoreraml/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "petstoreraml/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PetstoreramlError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = Petstoreraml(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Petstoreraml) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(PETSTORERAML_BASE_URL="http://localhost:5000/from/env"):
            client = Petstoreraml(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Petstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Petstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Petstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Petstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Petstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("petstoreraml._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: Petstoreraml, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncPetstoreraml:
    client = AsyncPetstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PetstoreramlError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncPetstoreraml(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPetstoreraml) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PETSTORERAML_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPetstoreraml(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncPetstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPetstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPetstoreraml) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPetstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPetstoreraml(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncPetstoreraml,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPetstoreraml, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from petstoreraml._utils import asyncify
        from petstoreraml._base_client import get_platform
